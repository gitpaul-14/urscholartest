                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex"> -->
                            ...
                            <!-- <div v-if="$page.props.auth.user.role == 'coordinator'"
                                ...
                                <!-- <NavLink :href="route('scholars.index')" :active="route().current('scholars.index')">
                                    Scholars
                                </NavLink> -->
                            <!-- </div>
                            <div v-else
                                ...
                                <NavLink :href="route('available.index')" :active="route().current('available.index')">
                                    Scholarships
                                </NavLink>
                            </div>
                        </div> -->
...
export default {
  ...
  setup() {
    ...
    function toggleScholarshipMenu(event) {
    ...
    function toggleScholarsMenu(event) {
      const rect = event.currentTarget.getBoundingClientRect();
      menuPosition.value = rect.top;
      sidebarWidth.value = rect.width;
    ...
    // Lifecycle hook to close menus when clicking outside
    onMounted(() => {
