<template>
    <div class="w-full bg-[F8F8FA] border">
      <div class="hidden lg:flex justify-between items-center h-[50px] place-content-center">
        ...
        <div class="flex items-center space-x-4 pr-5">
          ...
          <!-- <div class="flex items-center space-x-2">
            <div class="text-md font-poppins">Admin</div>
            <Avatar 
              icon="pi pi-user" 
              class="mr-2" 
      ...
      <!-- Mobile Navigation -->
      <div class="lg:hidden flex justify-between items-center h-[50px] place-content-center">
        <div class="flex items-center space-x-4">
          <div class="pl-1">
            <img src="../../assets/images/logo-hori.png" alt="" class="w-[160px] h-[40px]">
          </div>
        </div>
        <!-- Theme and Notification -->
        <div class="flex items-center space-x-4 pr-5">
          ...
          <div class="border border-gray-300 inline-flex items-center justify-center w-10 h-10 text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400 rounded-full" type="button"">
            <img
