<template>
    <div
    class="submenu-width lg:max-h-screen bg-white flex flex-col border-r transition-all duration-300"
    id="side-bar">
    <!-- desktop -->
...
<style scoped>
:root {
  --sidebar-width: 400px; /* Adjust this value to match your sidebar width */
}
